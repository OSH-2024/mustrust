...
![同类项目对比](F:\CSClasses\OSH\mustrust\docs\Final_Report\img\同类项目对比.png)
...
![重复定义](F:\CSClasses\OSH\mustrust\docs\Final_Report\img\重复定义.png)

**解决方案**：将重复定义的const常量改成宏定义的形式，如下图：

![const常量修改为宏](F:\CSClasses\OSH\mustrust\docs\Final_Report\img\const常量修改为宏_2.png)
...
![将函数功能的宏修改为函数](F:\CSClasses\OSH\mustrust\docs\Final_Report\img\将函数功能的宏修改为函数.png)
